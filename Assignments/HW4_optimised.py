...
class UniformCostSearchTree:
    ...
    def successor_fcn(self, current_position, visited, previous_path, cost):
        '''
        ...
        for x, y in neighbours:
            ...
            if (x + current_position[0], y + current_position[1]) in temp_visited:
                continue
            ...
            possible_paths.append(
                (cost + self.grid[x + current_position[0]][y + current_position[1]], (x + current_position[0], y + current_position[1]), temp_visited, previous_path + current_path))
    ...
    def search(self):
        try:
            ...
            fringe = [[0, self.start_position, {self.start_position}, ""]]
            heapify(fringe)
            ...
            while True:
                ...
                cost, present_position, visited, path = heappop(fringe)
                ...
                ret = self.successor_fcn(present_position, visited, path, cost)
